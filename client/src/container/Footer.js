        ...
        <div class="col-md-3 col-sm-12 footer-detail">
          <div class="footer-widget">
            <div class="widget-about ">
              ...
              <p>GOVERNMENT ASSOCIATE COLLEGE OF COMMERCE KABIRWALA<br />
                </p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="copyright-text">
            <p>© Copyright GOVERNMENT ASSOCIATE COLLEGE OF COMMERCE KABIRWALA {new Date().getFullYear()} | All Rights Reserved <br />
          ...
          {/* <div class="go_top">
            <span  onClick={() => {
          window.scrollTo({top: 0, left: 0, behavior: 'smooth'});}} class="icon-arrow-up">   
            </span>
          </div> */}
        </div>
      </div>
